...
namespace EncryptApi.Services
{
    public class Aes128Service
    {
        ...
        public static Aes128Output Encryption(Aes128Input Input)
        {
            ...
            else
            {
                ...
                data = AES128E(data.Item1, data.Item2);
                return Aes128Output.ToEncryptOutput(data);
            }
        }

        public static Aes128Output Decryption(Aes128Input Input)
        {
            ...
            {
                var data = input.Value;
                data = AES128D(data.Item1, data.Item2);
                return Aes128Output.ToDecryptOutput(data);
            }
        }
    }
}
